...
# Security group shared by the ALB, backend and frontend Fargate tasks.
# Ingress is scoped per consumer through separate rules so the ALB is the
# only thing reachable from the internet.
